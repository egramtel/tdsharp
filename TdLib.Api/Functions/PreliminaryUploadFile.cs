...
public partial class Client
{
    ...
    /// The upload will not be completed until the file is sent in a message
    /// </summary>
    public Task<File> PreliminaryUploadFileAsync(InputFile file = default, FileType fileType = default, int priority = default)
    {
    //test
        return ExecuteAsync(new PreliminaryUploadFile
        {
...
public partial interface IClient
{
    ...
    /// The upload will not be completed until the file is sent in a message
    /// </summary>
    Task<File> PreliminaryUploadFileAsync(InputFile file = default, FileType fileType = default, int priority = default);
}
