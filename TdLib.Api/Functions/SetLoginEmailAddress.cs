...
public partial class Client
{
    ...
    /// To use Apple ID/Google ID instead of an email address, call checkLoginEmailAddressCode directly
    /// </summary>
    public Task<EmailAddressAuthenticationCodeInfo> SetLoginEmailAddressAsync(string newLoginEmailAddress = default)
    {
    //test
        return ExecuteAsync(new SetLoginEmailAddress
        {
            NewLoginEmailAddress = newLoginEmailAddress
        });
    }
...
public partial interface IClient
{
    ...
    /// To use Apple ID/Google ID instead of an email address, call checkLoginEmailAddressCode directly
    /// </summary>
    Task<EmailAddressAuthenticationCodeInfo> SetLoginEmailAddressAsync(string newLoginEmailAddress = default);
}
