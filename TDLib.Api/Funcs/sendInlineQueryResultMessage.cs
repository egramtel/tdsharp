...
namespace TD {
    ...
    public partial class Methods : object
    {
        ...
        public partial class sendInlineQueryResultMessage : Method<Message>
        {

                [JsonProperty("@type")]
                public override string Type { get; set; } = "sendInlineQueryResultMessage";
